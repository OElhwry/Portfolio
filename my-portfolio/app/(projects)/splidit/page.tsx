...
export default function SplidItPage() {
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-screen-xl flex-col px-6 py-12 font-sans md:px-12 md:py-16 lg:flex-row lg:justify-between lg:gap-6 lg:py-0">
        ...
        <header className="lg:sticky lg:top-0 lg:flex lg:h-screen lg:w-[46%] lg:flex-col lg:justify-between lg:py-24">
          <div>
            <p className="mb-3 text-[10px] font-semibold uppercase tracking-[0.28em] text-emerald-400/50">
              Expense Splitter
            </p>
            <h1 className="text-4xl font-bold tracking-tight text-slate-100 sm:text-5xl">
              SplidIt
            </h1>
            <div className="mt-2 h-px w-16 bg-gradient-to-r from-emerald-400/70 to-transparent" />
          ...
          <div className="mt-10 flex flex-col gap-3">
            ...
            <Link
              href="https://github.com/OElhwry/SplidIt"
              target="_blank"
              rel="noreferrer"
        ...
        <div className="lg:w-[54%] py-24 space-y-24">
          ...
          >
            <div className="mb-7">
              <p className="mb-2 text-[10px] font-semibold uppercase tracking-[0.3em] text-emerald-400/45">
                What it does
              </p>
              ...
              {[
                {
                  ...
                  body: "Debt minimisation algorithm finds the fewest transfers to settle everyone — no unnecessary back-and-forth.",
                },
                {
                  icon: (
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
                  ...
                  title: "Two split modes",
                  body: "Equal splits for simple situations. Custom percentage breakdowns when contributions aren't the same.",
                },
                {
                  icon: (
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
                  ...
                  title: "Live balance view",
                  body: "Colour-coded real-time preview of who owes and who gets paid back as you adjust values.",
                },
                {
                  icon: (
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
                  ...
                  title: "Three share options",
                  body: "Copy as plain text, export as an image via html2canvas, or send a shareable link.",
                },
              ].map((f) => (
                <div
                  key={f.title}
                  className="rounded-xl p-4 transition-all hover:border-emerald-400/25"
                  style={{
                ...
                >
                  <div
                    className="mb-3 inline-flex items-center justify-center rounded-lg p-2 text-emerald-400"
